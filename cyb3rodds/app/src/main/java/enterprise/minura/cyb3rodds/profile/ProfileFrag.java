...
public class ProfileFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView first, last, country, email;
        String firstname, lastname, mail, count;
        ...
        firstname= gb.getFirstname().toString();
        lastname= gb.getLastname().toString();
        mail= gb.getEmail().toString();
        count= gb.getCountry().toString();
        ...
        change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Fragment newFrag= new ProfileChangeFrag();
        ...
        info2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.setMessage("This is your profile, your data has you registered!").setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                    @Override
